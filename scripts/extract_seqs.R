...
writeXStringSet(dechloro_seqs, file.path(onedrive_path, "./parsed_data/dechloro_seqs.fasta"))
writeXStringSet(comp_seqs, file.path(onedrive_path, "./parsed_data/comp_seqs.fasta"))
